...
import svgPaths from "./svg-w6ri2trv5r";
    ...
    <motion.div className="relative shrink-0 size-[88px]" data-name="Frame">
      <div className="absolute inset-[-11.36%_-15.91%_-20.45%_-15.91%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 116 116">
          <g filter="url(#filter0_d_2218_582)" id="Frame">
            <rect fill="url(#paint0_radial_2218_582)" height="88" rx="22" shapeRendering="crispEdges" width="88" x="14" y="10" />
            <g id="Vector">
          ...
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="116" id="filter0_d_2218_582" width="116" x="0" y="0">
              ...
              <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_2218_582" />
              <feBlend in="SourceGraphic" in2="effect1_dropShadow_2218_582" mode="normal" result="shape" />
            </filter>
            <radialGradient cx="0" cy="0" gradientTransform="matrix(0 79.2 44 35.2 58 18.8)" gradientUnits="userSpaceOnUse" id="paint0_radial_2218_582" r="1">
    ...
    <div className="relative size-full" style={{ backgroundImage: "url(\"data:image/svg+xml;utf8,<svg viewBox='0 0 393 852' xmlns='http://www.w3.org/2000/svg' preserveAspectRatio='none'><rect x='0' y='0' height='100%' width='100%' fill='url(%23grad)' opacity='1'/><defs><radialGradient id='grad' gradientUnits='userSpaceOnUse' cx='0' cy='0' r='10' gradientTransform='matrix(0 59.64 15.72 0 196.5 127.8)'><stop stop-color='rgba(237,238,255,1)' offset='0'/><stop stop-color='rgba(244,244,255,1)' offset='0.55'/><stop stop-color='rgba(255,255,255,1)' offset='1'/></radialGradient></defs></svg>\")" }} data-name="Home page/Mobile">
      <motion.div className="absolute left-[-60px] size-[280px] top-[-40px]" data-name="Ellipse">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 280 280">
          <circle cx="140" cy="140" fill="url(#paint0_radial_2218_552)" id="Ellipse" r="140" />
          <defs>
            <radialGradient cx="0" cy="0" gradientTransform="translate(140 140) rotate(90) scale(140)" gradientUnits="userSpaceOnUse" id="paint0_radial_2218_552" r="1">
      ...
      <motion.div className="absolute left-[220px] size-[240px] top-[560px]" data-name="Ellipse">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 240 240">
          <circle cx="120" cy="120" fill="url(#paint0_radial_2218_524)" id="Ellipse" r="120" />
          <defs>
            <radialGradient cx="0" cy="0" gradientTransform="translate(120 120) rotate(90) scale(120)" gradientUnits="userSpaceOnUse" id="paint0_radial_2218_524" r="1">
              <stop stopColor="#B8D4F5" stopOpacity="0.25098" />
              <stop offset="1" stopColor="#B8D4F5" stopOpacity="0" />
            </radialGradient>
          </defs>
        </svg>
      </motion.div>

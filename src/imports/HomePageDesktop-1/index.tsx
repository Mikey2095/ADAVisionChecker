import svgPaths from "./svg-hiipsb0tdf";
...
function Frame() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-center left-[90px] top-[555px] w-[820px]">
      ...
      <Divder />
      <div className="[word-break:break-word] flex flex-col font-['Inter:Light',sans-serif] font-light justify-center leading-[0] not-italic relative shrink-0 text-[24.571px] text-center text-white w-[629.643px]">
        <p className="leading-[43px]">Simulate visual impairments, test contrast, and build inclusive digital experiences</p>
      </div>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-white content-stretch flex h-[50px] items-center justify-center left-[calc(50%+0.5px)] p-[5.546px] rounded-[16.639px] top-[calc(50%+404px)] w-[629px]">
